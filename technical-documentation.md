...
`rainbow-bot` 当前为 3D SVG 版本：
- 头身球形渐变（左上高光、右下阴影）
- 面罩由纯深色改为深蓝发光分层面板，避免“整脸发黑”
- 四肢圆柱渐变
- 默认嘴型为微笑
- 走路时手臂与腿部反向摆动
- 待机眨眼节奏已提频（约 2.4s / 2.7s 双眼错峰）
...
当前行为约束：
- 展开后有约 1.8 秒锁定期，避免移动鼠标时误收起
- 鼠标进入菜单区域不会隐藏
- 仅当离开宠物与菜单后延迟约 420ms 收起
