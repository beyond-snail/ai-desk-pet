...
> 状态声明（2026-03-13）：
> 本文档为 Electron 时代实现快照，仅用于历史语义追溯。
> 当前主线执行基线已切换到 Runtime3D 文档体系：
> `docs/3d-runtime-migration-spec.md` 与 `docs/3d-runtime-migration-tasks-for-codex.md`。

## 1. 文档定位

本文档描述 Electron 主线阶段的实现状态，面向以下用途：
- 让 Claude / Codex / 其他工程代理快速理解当前代码基线
- 作为桌面端 v1.0（Electron 阶段）的实现说明，而不是历史规划草案
